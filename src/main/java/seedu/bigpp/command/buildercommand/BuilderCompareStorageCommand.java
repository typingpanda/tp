...
public class BuilderCompareStorageCommand extends Command {
    ...
    public String executeCommand(DataStorage dataStorage)
        ...
        outputString += String.format("%n|%-12s|%-35s|%-35s|", "TYPE", firstComponentObject.getType(),
                secondComponentObject.getType());
        outputString += String.format("%n|%-12s|%-35s|%-35s|", "SIZE", firstComponentObject.getSize() + "GB",
